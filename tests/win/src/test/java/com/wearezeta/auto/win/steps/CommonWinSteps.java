...
public class CommonWinSteps {
    ...
    public CommonWinSteps() {
        this.context = new WrapperTestContext();
    }

    public CommonWinSteps(WrapperTestContext context) {
        ...
        if (doesNot == null) {
            ...
            if (!WebAppExecutionContext.getBrowser().isSupportingCalls()) {
                throw new PendingException(
                        "Browser " + WebAppExecutionContext.getBrowser().toString() + " does not support calling.");
            }
        } else {
            // should not support calling
            if (WebAppExecutionContext.getBrowser().isSupportingCalls()) {
                throw new PendingException(
                        "Browser " + WebAppExecutionContext.getBrowser().toString() + " does support calling but this test is just for browsers without support.");
            }
        }
    }
    ...
    public void ThereAreNUsersWhereXIsMe(int count, String myNameAlias) throws Exception {
        context.getCommonSteps().ThereAreNUsersWhereXIsMe(WinExecutionContext.CURRENT_PLATFORM, count, myNameAlias);
    ...
    public void IChangeUserAvatarPicture(String userNameAlias, String path) throws Exception {
        ...
        context.getCommonSteps().IChangeUserAvatarPicture(userNameAlias, pathString);
    }
    ...
    public void UserHasGroupChatWithContacts(String chatOwnerNameAlias, String chatName, String otherParticipantsNameAlises)
            throws Exception {
        context.getCommonSteps().UserHasGroupChatWithContacts(chatOwnerNameAlias, chatName, otherParticipantsNameAlises);
    }
    ...
    public void MuteConversationWithUser(String userToNameAlias, String muteUserNameAlias) throws Exception {
        context.getCommonSteps().MuteConversationWithUser(userToNameAlias, muteUserNameAlias);
    }
    ...
    public void ArchiveConversationWithUser(String userToNameAlias, String archivedUserNameAlias) throws Exception {
        context.getCommonSteps().ArchiveConversationWithUser(userToNameAlias, archivedUserNameAlias);
    }
    ...
    public void UserPingedConversation(String pingFromUserNameAlias, String dstConversationName) throws Exception {
        context.getCommonSteps().UserPingedConversation(pingFromUserNameAlias, dstConversationName);
    }

    @When("^User (.*) sent message (.*) to conversation (.*)")
    public void UserSentMessageToConversation(String userFromNameAlias, String message, String conversationName) throws
            Exception {
        context.getCommonSteps().UserSentMessageToConversation(userFromNameAlias, conversationName, message);
    }
    ...
    public void UserXAddedContactsToGroupChat(String asUser, String contacts, String conversationName) throws Exception {
        context.getCommonSteps().UserXAddedContactsToGroupChat(asUser, contacts, conversationName);
    }
    ...
    public void clickMenuBarItem(String menuBarItemName, String menuItemName) throws Exception {
        MainWirePage mainPage = context.getWinPagesCollection().getPage(MainWirePage.class);
    ...
    public void clickMenuBarItem(String menuBarItemName) throws Exception {
        context.getWinPagesCollection().getPage(MainWirePage.class).clickMenuBarItem(menuBarItemName);
    }

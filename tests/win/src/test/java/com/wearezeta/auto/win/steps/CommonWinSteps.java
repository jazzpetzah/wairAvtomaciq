...
public class CommonWinSteps {
    ...
    /**
     * Will click a menu bar item and a menu item within the menu bar item and another menu item within the menu item.
     *
     *
    ...
    /**
     * Shows all elements for a specific locator. This step is meant for debugging purposes.
     *
     *

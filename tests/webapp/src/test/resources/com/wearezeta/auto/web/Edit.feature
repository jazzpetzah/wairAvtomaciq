Feature: Edit
  ...
  @C368976 @edit @known @WEBAPP-3422
  Scenario Outline: Verify I do not loose messages when someone edits a message from a long time ago
    ...
    Given I am signed in properly
    When I open conversation with <Contact1>
    And Contact <Contact1> sends 10 messages with prefix <Prefix1> via device Device1 to user <Name>
    And I remember the message <Prefix1>1
    And Contact <Contact1> sends 30 messages with prefix <Prefix2> via device Device1 to user <Name>
    When I open conversation with <Contact2>
    ...
    And I see text message <Prefix2>29

    Examples:
      | Login      | Password      | Name      | Contact1  | Contact2  | Prefix1 | Prefix2 | EditedMessage |
      | user1Email | user1Password | user1Name | user2Name | user3Name | first   | second  | edited        |
Feature: E2EE
  ...
  #And I click confirm on history info page
    ...
    Examples:
      | Email      | Password      | Name      | Contact1  | Contact2  | Email3     | Password3     | GroupChatName | Message         |
      | user1Email | user1Password | user1Name | user2Name | user3Name | user4Email | user4Password | User1Chat     | Hello User1Chat |

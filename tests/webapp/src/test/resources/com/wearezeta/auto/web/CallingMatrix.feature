...
#    And <Contact> verifies that call to conversation <Contact> was successful
    ...
    Examples: 
      | Login      | Password      | Name      | Contact   | CallBackend       | Timeout |
      | user1Email | user1Password | user1Name | user2Name | autocall:2.7.25   | 20      |
# not necessary due to same versions in android and ios
#      | user1Email | user1Password | user1Name | user2Name | autocall:2.3.8   | 20      |
  ...
  Scenario Outline: Verify I can make audio group call with multiple AVS <WaitBackend>
    ...
    Examples: 
      ...
      | user1Email | user1Password | user1Name | user2Name | user3Name | GroupCall | zcall:2.7.25   | 30      |
# not necessary due to same versions in android and ios
#      | user1Email | user1Password | user1Name | user2Name | user3Name | GroupCall | zcall:2.3.8    | 30      |
  ...
  Scenario Outline: Verify I can join audio group call with AVS <Backend> and <WaitBackend>
    ...
    Examples: 
      ...
      | user1Email | user1Password | user1Name | user2Name | user3Name | user4Name | user5Name | GroupCall | autocall:2.7.25  | chrome:52.0.2743.82  | 30      |
      | user1Email | user1Password | user1Name | user2Name | user3Name | user4Name | user5Name | GroupCall | autocall:2.7.25  | chrome:51.0.2704.106 | 30      |
      | user1Email | user1Password | user1Name | user2Name | user3Name | user4Name | user5Name | GroupCall | autocall:2.7.25  | firefox:46.0.1       | 30      |
      | user1Email | user1Password | user1Name | user2Name | user3Name | user4Name | user5Name | GroupCall | autocall:2.7.25  | firefox:45.0.1       | 30      |
# not necessary due to same versions in android and ios
...
#      | user1Email | user1Password | user1Name | user2Name | user3Name | user4Name | user5Name | GroupCall | autocall:2.2.38 | firefox:45.0.1       | 30      |
  ...
  Scenario Outline: Verify I can join audio group call with AVS <Backend> and <WaitBackend>
    ...
    Examples: 
      ...
      | user1Email | user1Password | user1Name | user2Name | user3Name | GroupCall | autocall:2.7.25   | zcall:2.7.25  | 30      |
# not necessary due to same versions in android and ios
...
#      | user1Email | user1Password | user1Name | user2Name | user3Name | GroupCall | autocall:2.2.38  | zcall:2.2.46 | 30      |
  ...
  Scenario Outline: Verify I can create, leave and rejoin an audio group call with AVS <WaitBackend>
    ...
    Examples:
      | Login      | Password      | Name      | Contact1  | Contact2  | ChatName              | WaitBackend  | Timeout |
      | user1Email | user1Password | user1Name | user2Name | user3Name | GroupCallConversation | zcall:2.7.25 | 30      |
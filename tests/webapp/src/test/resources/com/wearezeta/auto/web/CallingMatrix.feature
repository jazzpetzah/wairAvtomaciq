...
# Leaving out last participant - call gets destroyed automatically
    ...
    Examples: 
      ...
      | user1Email | user1Password | user1Name | user2Name | user3Name | GroupCall | zcall:3.1.20   | 30      |
...
# Leaving out last participant - call gets destroyed automatically
    ...
    Examples: 
      ...
      | user1Email | user1Password | user1Name | user2Name | user3Name | GroupCall | zcall:2.9.14   | zcall:3.1.20  | 30      |
      | user1Email | user1Password | user1Name | user2Name | user3Name | GroupCall | zcall:3.1.20   | zcall:2.9.14  | 30      |
...
# Stops all outgoing instance calls
    ...
    Examples:
      | Login      | Password      | Name      | Contact1  | Contact2  | ChatName              | WaitBackend  | Timeout |
      | user1Email | user1Password | user1Name | user2Name | user3Name | GroupCallConversation | zcall:3.1.20 | 30      |

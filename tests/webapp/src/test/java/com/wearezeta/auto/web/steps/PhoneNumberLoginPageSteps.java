...
public class PhoneNumberLoginPageSteps {
    ...
    public void ISignInUsignPhoneNumberOfUser(String name) throws Exception {
        ...
        webappPagesCollection.getPage(PhoneNumberLoginPage.class).enterCountryCode(PhoneNumber.WIRE_COUNTRY_PREFIX);
        webappPagesCollection.getPage(PhoneNumberLoginPage.class).enterPhoneNumber(number);
    }
    ...
    public void IClickOnForwardButtonOnPhoneNumberSignIn() throws Exception {
        webappPagesCollection.getPage(PhoneNumberLoginPage.class).clickSignInButton();
    }
    ...
    public void ISeeInvalidPhoneNumberErrorMessageSayingX(String message) throws Exception {
        assertThat("invalid phone number error", webappPagesCollection.getPage(PhoneNumberLoginPage.class).getErrorMessage(),
            equalTo(message));
    }
}

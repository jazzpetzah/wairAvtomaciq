...
public class AddEmailAddressPageSteps {
    ...
    public void IEnterEmailOfUserOnAddEmailAddressDialog(String name) throws Throwable {
        ...
        webappPagesCollection.getPage(AddEmailAddressPage.class).setEmail(user.getEmail());
    }
    ...
    public void IEnterEmailOnAddEmailAddressDialog(String email) throws Throwable {
        webappPagesCollection.getPage(AddEmailAddressPage.class).setEmail(email);
    }
    ...
    public void IEnterPasswordOnAddEmailAddressDialog(String password) throws Exception {
        webappPagesCollection.getPage(AddEmailAddressPage.class).setPassword(password);
    }
    ...
    public void IClickAddButtonOnAddEmailAddressDialog() throws Exception {
        webappPagesCollection.getPage(AddEmailAddressPage.class).clickAddButton();
    }
    ...
    public void ISeeSkipForNowButtonOnAddEmailAddressDialog() throws Exception {
        webappPagesCollection.getPage(AddEmailAddressPage.class).isSkipButtonVisible();
    }
    ...
    public void IClickSkipForNowButtonOnAddEmailAddressDialog() throws Exception {
        webappPagesCollection.getPage(AddEmailAddressPage.class).clickSkipForNowButton();
    }
    ...
    public void ISeeErrorMessageOnAddEmailAddressDialog(String message) throws Exception {
        assertThat("invalid email error", webappPagesCollection.getPage(AddEmailAddressPage.class).getErrorMessage(),
            equalTo(message));
    }

    /**
     * Checks if a orange line is shown around the email field on add email address dialog
     *
    ...
    public void EmailFieldIsMarkedAsError() throws Exception {
        assertThat("email field marked as error", webappPagesCollection.getPage(AddEmailAddressPage.class)
            .isEmailFieldMarkedAsError());
    }

    /**
     * Checks if a orange line is shown around the password field on add email address dialog form
     *
    ...
    public void ARedDotIsShownOnThePasswordField() throws Exception {
        assertThat("password field marked as error", webappPagesCollection.getPage(AddEmailAddressPage.class)

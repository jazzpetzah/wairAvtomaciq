...
public class CallingSteps {
    ...
    public void UserXCallsToUserYUsingCallBackend(String caller,
        ...
        commonCallingSteps.callToConversation(caller,
            conversationName, callBackend);
    }
    ...
    public void UserXStopsCallsToUserY(String caller,
        String conversationName) throws Exception {
        commonCallingSteps.stopCall(caller,
            conversationName);
    }
     ...
     * Available values: "starting", "waiting", "active", "active_muted",
     * "stopping", "inactive"
    ...
    public void UserXVerifesCallStatusToUserY(String caller,
        ...
        throws Exception {
        commonCallingSteps.verifyCallingStatus(caller,
    ...
    public void UserXStartsWaitingInstance(String callee,
        ...
        commonCallingSteps.startWaitingInstance(callee,
    ...
    public void UserXStopsIncomingCalls(String callee)
        throws Exception {

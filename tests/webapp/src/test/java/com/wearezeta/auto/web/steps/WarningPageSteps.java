...
public class WarningPageSteps {
     ...
     *
     * @param doNot is null when 'do not' part is not present
     * @step. ^I see a warning$
     *
     * @throws Exception if the 'missing WebRTC support warning bar' is not
     * currently * visible
     */
     ...
     * support warning bar'.
     *
     * @param linkCaption the caption of the link to look for
     * @throws java.lang.Exception
     ...
     *
     * @throws Exception if the 'another call warning modal' is not currently
     * visible
     */
     ...
     *
     * @param buttonCaption the caption of the button to click
     * @throws java.lang.Exception
     ...
     *
     * @throws Exception if the 'full call warning modal' is not currently
     * visible
     */

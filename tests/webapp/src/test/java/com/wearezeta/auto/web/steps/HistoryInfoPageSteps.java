...
public class HistoryInfoPageSteps {
    ...
    public void ISeeConfirmButton() throws Exception {
        assertThat("Confirm button not visible", webappPagesCollection.getPage(HistoryInfoPage.class).isConfirmButtonVisible());
    }

    @Then("^I click confirm on history info page$")
    public void IClickConfirmButton() throws Exception {
        webappPagesCollection.getPage(HistoryInfoPage.class).clickConfirmButton();
    }
}

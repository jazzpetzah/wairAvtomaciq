...
public class ConnectToPopoverPageSteps {
    ...
    public void IAcceptConnectionRequestFromUser() throws Exception {
        webappPagesCollection.getPage(ConnectToPopoverContainer.class).clickConnectButton();
    }
    ...
    public void ISeeConnectToPopover() throws Exception {
        webappPagesCollection.getPage(ConnectToPopoverContainer.class).waitUntilVisibleOrThrowException();
    }
    ...
    public void ISeePendingOutgoingConnectionPopover(String doNot) throws Exception {
        if (doNot == null) {
            webappPagesCollection.getPage(ConnectToPopoverContainer.class).waitUntilVisibleOrThrowException();
        } else {
            webappPagesCollection.getPage(ConnectToPopoverContainer.class).waitUntilNotVisibleOrThrowException();
        }
    }
    ...
    public void IClickCancelRequestButtonOnPendingOutgoingConnectionPopover() throws Exception {
        webappPagesCollection.getPage(ConnectToPopoverContainer.class).clickCancelRequestButton();
    }
    ...
    public void IClickNoButtonOnCancelRequestConfirmationPopover() throws Exception {
        webappPagesCollection.getPage(ConnectToPopoverContainer.class).clickNoButton();
    }
    ...
    public void IClickYesButtonOnCancelRequestConfirmationPopover() throws Exception {
        webappPagesCollection.getPage(ConnectToPopoverContainer.class).clickYesButton();
    }
}

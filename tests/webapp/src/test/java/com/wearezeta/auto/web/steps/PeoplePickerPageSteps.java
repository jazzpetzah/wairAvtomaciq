...
public class PeoplePickerPageSteps {
    ...
    public void ISelectUserFromPeoplePickerResults(String user) throws Exception {
        ...
        webappPagesCollection.getPage(PeoplePickerPage.class).selectUserFromSearchResult(user);
    }
    ...
    public void IWaitForSearchFieldToBeEmpty() throws Exception {
        webappPagesCollection.getPage(PeoplePickerPage.class).waitForSearchFieldToBeEmpty();
    }
    ...
    public void ISearchForUser(String nameOrEmail) throws Exception {
        nameOrEmail = usrMgr.replaceAliasesOccurences(nameOrEmail, FindBy.NAME_ALIAS);
        nameOrEmail = usrMgr.replaceAliasesOccurences(nameOrEmail, FindBy.EMAIL_ALIAS);
        // adding spaces to ensure trimming of input
        webappPagesCollection.getPage(PeoplePickerPage.class).searchForUser(" " + nameOrEmail + " ");
    }
    ...
    public void ISeeUserFoundInPeoplePicker(String donot, String name) throws Exception {
        name = usrMgr.replaceAliasesOccurences(name, FindBy.NAME_ALIAS);

        if (donot == null) {
            Assert.assertTrue(webappPagesCollection.getPage(PeoplePickerPage.class).isUserFound(name));
        } else {
            Assert.assertTrue(webappPagesCollection.getPage(PeoplePickerPage.class).isUserNotFound(name));
        }
    }
    ...
    public void IClickRemoveButton(String contact) throws Exception {
        ...
        webappPagesCollection.getPage(PeoplePickerPage.class).clickRemoveButtonOnSuggestion(contact);
    }
    ...
    public void IClickPlusButton(String contact) throws Exception {
        contact = usrMgr.replaceAliasesOccurences(contact, FindBy.NAME_ALIAS);
        webappPagesCollection.getPage(PeoplePickerPage.class).clickPlusButtonOnSuggestion(contact);
    }
    ...
    public void IClickNotConnecteUserFoundInPeoplePicker(String userType, String name) throws Exception {
        name = usrMgr.replaceAliasesOccurences(name, FindBy.NAME_ALIAS);
        if (userType.equalsIgnoreCase("not connected")) {
            webappPagesCollection.getPage(PeoplePickerPage.class).clickNotConnectedUserName(name);
        } else if (userType.equalsIgnoreCase("pending")) {
            webappPagesCollection.getPage(PeoplePickerPage.class).clickPendingUserName(name);
        }
    }
    ...
    public void IChooseToCreateConversationFromPeoplePicker() throws Exception {
        webappPagesCollection.getPage(PeoplePickerPage.class).createConversation();
    }

    @Then("^I see more than (\\d+) suggestions? in people picker$")
    public void ISeeMoreThanXSuggestionsInPeoplePicker(int count) throws Exception {
        assertThat("people suggestions", webappPagesCollection.getPage(PeoplePickerPage.class).getNumberOfSuggestions(),
            greaterThan(count));
    }
    ...
    public void ISeeSendInvitationButton() throws Exception {
        webappPagesCollection.getPage(PeoplePickerPage.class).waitUntilBringYourFriendsOrInvitePeopleButtonIsVisible();
    }
    ...
    public void IDoNotSeeGmailImportButton() throws Exception {
        webappPagesCollection.getPage(BringYourFriendsPopoverPage.class).waitUntilGmailImportButtonIsNotVisible();
    }
    ...
    public void IClickButtonToBringFriendsFromGmail() throws Exception {
        webappPagesCollection.getPage(PeoplePickerPage.class).clickBringFriendsFromGmailButton();
    }
    ...
    public void ISeeGoogleLoginPopup() throws Exception {
        webappPagesCollection.getPage(PeoplePickerPage.class).switchToGooglePopup();
    }
    ...
    public void ISignUpAtGoogleWithEmail(String email, String password) throws Exception {
        GoogleLoginPage googleLoginPage = webappPagesCollection.getPage(GoogleLoginPage.class);
    ...
    public void IClickBringYourFriendsOrInvitePeopleButton() throws Exception {
        webappPagesCollection.getPage(PeoplePickerPage.class).clickBringYourFriendsOrInvitePeopleButton();
    }
    ...
    public void IwaitTillTopPeopleListAppears() throws Exception {
        if (!webappPagesCollection.getPage(PeoplePickerPage.class).isTopPeopleLabelVisible())
            webappPagesCollection.getPage(PeoplePickerPage.class).closeSearch();
        webappPagesCollection.getPage(ContactListPage.class).openPeoplePicker();
        Assert.assertTrue("Top People list is not shown", webappPagesCollection.getPage(PeoplePickerPage.class)
    ...
    public void ISelectUsersFromTopPeople(String namesOfTopPeople) throws Exception {
        for (String alias : CommonSteps.splitAliases(namesOfTopPeople)) {
            final String userName = usrMgr.findUserByNameOrNameAlias(alias).getName();
            webappPagesCollection.getPage(PeoplePickerPage.class).clickNameInTopPeople(userName);
        }
    }
    ...
    public void IRememberUserNamesSelectedInTopPeople() throws Exception {
        selectedTopPeople = webappPagesCollection.getPage(PeoplePickerPage.class).getNamesOfSelectedTopPeople();
    }
    ...
    public void ISeeSearchIsOpened() throws Exception {
        ...
        Assert.assertTrue(searchMissingMessage, webappPagesCollection.getPage(PeoplePickerPage.class).isSearchOpened());
    }
    ...
    public void ISeeGroupFoundInPeoplePicker(String donot, String name) throws Exception {

        if (donot == null) {
            Assert.assertTrue(webappPagesCollection.getPage(PeoplePickerPage.class).isGroupConversationFound(name));
        } else {
            Assert.assertTrue(webappPagesCollection.getPage(PeoplePickerPage.class).isGroupConversationNotFound(name));
        }
    }
    ...
    public void ISeeMoreButton() throws Exception {
        ...
        Assert.assertTrue(searchMissingMessage, webappPagesCollection.getPage(PeoplePickerPage.class).isMoreButtonVisible());
    ...
    public void ISeeXPeopleInTopPeopleList(int count) throws Exception {
        assertThat("people suggestions", webappPagesCollection.getPage(PeoplePickerPage.class).getNumberOfTopPeople(),
            equalTo(count));
    }
}

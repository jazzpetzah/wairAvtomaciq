...
public final class PopoverLocators {
    ...
    public static final class ConnectToPopover {
        ...
        public static final class ConnectToPage {
            ...
            public static final String xpathConnectButton = xpathRootLocator + "//*[@data-uie-name='do-connect']";
        }

        public static final class PendingOutgoingConnectionPage {

            public static final String xpathCancelRequestButton = xpathRootLocator + "//*[@data-uie-name='go-cancel']";
        }
    ...
    public static final class SingleUserPopover {
        ...
        public static final class SingleUserInfoPage {
            ...
            public static final String xpathBlockButton = xpathRootLocator + xpathPageRootLocator
                + "//*[@data-uie-name='do-block']";

            public static final String xpathOpenConversationButton = xpathRootLocator + xpathPageRootLocator
                + "//*[@data-uie-name='go-conversation']";

            public static final String xpathUnblockButton = xpathPageRootLocator + "//*[@data-uie-name='do-unblock']";
    ...
    public static final class GroupPopover {
        ...
        public static final class ParticipantsListPage {
            ...
            private static final String xpathHeaderDiv = xpathRootLocator + xpathPageRootLocator
                + "//div[contains(@class, 'participants-group-header')]";

            public static final String xpathConversationTitle = xpathRootLocator + "//*[@data-uie-name='status-name']";

            public static final String xpathConversationTitleInput = xpathHeaderDiv + "/div[contains(@class, 'name')]/textarea";

            public static final String xpathLeaveGroupChat = xpathRootLocator + xpathPageRootLocator
                + "//*[@data-uie-name='do-leave']";

            public static final String cssParticipants = "#participants-bubble [data-uie-name='item-user']";

            public static final Function<String, String> xpathParticipantByName = (name) -> String.format(
                "%s//*[@data-uie-name='item-user' and .//*[text()='%s']]", xpathRootLocator + xpathPageRootLocator, name);
        ...
        public static final class ConnectParticipantConfirmationPage {
            ...
            public static final String xpathConfirmConnectButton = xpathRootLocator + "//*[@data-uie-name='do-connect']";

            public static final String xpathIgnoreConnectButton = xpathRootLocator + "//*[@data-uie-name='do-ignore']";
        }

        public static final class ParticipantInfoPage {

            public static final String xpathRemoveButton = xpathRootLocator + "//*[@data-uie-name='do-remove']";

            public static final String xpathEmailLabel = xpathRootLocator + "//*[@data-uie-name='status-user-email']";

            public static final String xpathAvatar = xpathRootLocator + "//*[@data-uie-name='status-profile-picture']";

            public static final String xpathUserName = xpathRootLocator + "//*[@data-uie-name='status-user']";
        }

        public static final class SelfInfoPage {

            public static final String xpathProfileButton = xpathRootLocator + "//*[@data-uie-name='go-profile']";
        }

        public static final class PendingParticipantPage {

            public static final String xpathPendingButton = xpathRootLocator + "//*[@data-uie-name='go-conversation']";

            public static final String xpathPendingTextBox = xpathRootLocator + "//*[@data-uie-name='enter-connect-message']";
        }

        public static final class ConnectedParticipantPage {

            public static final String xpathOpenConversationButton = xpathRootLocator + "//*[@data-uie-name='go-conversation']";
        }
        ...
        public static final class BlockedParticipantPage {
            ...
            public static final String xpathUnblockButton = xpathRootLocator + "//*[@data-uie-name='do-unblock']";
        }

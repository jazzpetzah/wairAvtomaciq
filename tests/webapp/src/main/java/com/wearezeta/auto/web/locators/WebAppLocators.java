...
public final class WebAppLocators {
    ...
    public static final class ContactListPage {
        ...
        public static final Function<String, String> xpathListItemRootWithControlsByName = name -> String
            .format(
                "//*[@data-uie-name='item-conversation' and @data-uie-value='%s']/following-sibling::div[contains(@class, 'controls')]",
                name);
        ...
        public static final Function<String, String> xpathMuteIconByContactName = (name) -> String.format(
            "//*[@data-uie-name='item-conversation' and @data-uie-value='%s']/following::"
                + "*[@data-uie-name='status-silence']", name);

        public static final Function<String, String> cssContactListEntryByName = (name) -> String
            .format(
                "%s div[data-uie-name='item-conversation'][data-uie-value='%s'], %s div[data-uie-name='item-call'][data-uie-value='%s']",
                cssParentContactListItem, name, cssParentContactListItem, name);

        public static final Function<String, String> cssOptionsButtonByContactName = (name) -> String.format(
            "%s div[data-uie-name='item-conversation'][data-uie-value='%s']+ div span[data-uie-name='go-options']",
            cssParentContactListItem, name, cssParentContactListItem, name);

        public static final Function<String, String> cssArchiveListEntryByName = (name) -> String.format(
            "%s div[data-uie-name='item-conversation-archived'][data-uie-value='%s']", cssParentContactListItem, name);
        ...
        public static final Function<String, String> xpathOngoingCallListItemWithConvName = (name) -> String.format(
            "//div[@data-uie-name='item-call' and @data-uie-value='%s']", name);
        ...
        public static final Function<Integer, String> xpathContactListEntryByIndex = (idx) -> String.format("(%s)[%s]",
            xpathContactListEntries, idx);
        ...
        public static final Function<String, String> xpathArchivedContactListEntryByName = (name) -> String.format(
            "%s//*[@data-uie-name='item-conversation-archived' and ./ancestor-or-self::*[@data-uie-value='%s']]",
            xpathParentContactListItem, name);

        public static final String cssOpenPeoplePickerButton = "[data-uie-name=enter-search]";

        public static final Function<String, String> xpathMissedCallNotificationByContactName = (name) -> String
            .format(
                "//*[contains(@class, 'conversation-list-item') and div[@data-uie-value='%s']]//*[local-name() = 'svg' and @data-uie-name='status-unread']",
                name);

        public static final Function<String, String> xpathJoinedGroupCallNotificationByConversationName = (name) -> String
            .format(
                "//*[contains(@class, 'conversation-list-item') and div[@data-uie-value='%s']]//*[@data-uie-name='status-call' and @data-uie-value='participating-in-group-call']",
                name);

        public static final Function<String, String> xpathUnjoinedGroupCallNotificationByConversationName = (name) -> String
            .format(
                "//*[contains(@class, 'conversation-list-item') and div[@data-uie-value='%s']]//*[@data-uie-name='status-call' and @data-uie-value='not-participating-in-group-call']",
                name);

        public static final Function<String, String> xpathPingIconByContactName = (name) -> String.format(
            "//*[@data-uie-name='item-conversation' and @data-uie-value='%s']/parent::"
                + "*//*[@data-uie-name='status-unread' and contains(@class, 'icon-ping')]", name);

        public static final Function<String, String> xpathUnreadDotByContactName = (name) -> String.format(
            "//*[@data-uie-name='item-conversation' and @data-uie-value='%s']/..//*[@data-uie-name='status-unread']", name);
    ...
    public static final class SettingsPage {
        ...
        public static final Function<String, String> xpathDeviceLabel = (name) -> String.format(
            "//device-card//span[contains(text(),'%s')]", name);
    ...
    public static final class SelfProfilePage {
        ...
        public static final Function<String, String> xpathGearMenuItemByName = (name) -> String.format("%s//li[text()='%s']",
        ...
        public static final String xpathAccentColorPickerChildren = xpathAccentColorPicker + "/div";

        public static final Function<Integer, String> xpathAccentColorDivById = (id) -> String.format("%s[%s]",
            xpathAccentColorPickerChildren, id);
    ...
    public static final class ConversationPage {
        ...
        public static final String cssLastTextMessage = cssLastMessage + " .text-inner";

        public static final String cssSecondLastTextMessage = cssSecondLastMessage + " .text-inner";
        ...
        public static final Function<String, String> xpathMessageEntryByText = text -> String.format(
            "//*[@data-uie-name='item-message']//div[contains(@class, 'text') and text()='%s']", text);

        public static final Function<String, String> textMessageByText = text -> String.format(
            "//*[@data-uie-name='item-message']//*[text()='%s']", text);

        public static final Function<String, String> xpathEmbeddedYoutubeVideoById = text -> String.format(
            "//iframe[contains(@src, '%s')]", text);
        ...
        public static final Function<String, String> xpathCallingBarRootByName = text -> String.format(xpathCallingBarRoot
            + "//span[contains(text(),'%s')]|" + xpathCallingBarRoot
            + "//*[contains(@class, 'cc-avatar-label') and text()='%s']", text, text);
        ...
        public static final Function<String, String> cssUserAvatarById = id -> String.format(
            "[user-id='%s'] .user-avatar-border", id);
    ...
    public static final class ConnectToPage {
        ...
        public static final Function<String, String> cssRequestById = uid -> String.format(
            "[data-uie-name='connect-request'][data-uie-uid='%s']", uid);

        public static final Function<String, String> cssAcceptRequestButtonByUserId = uid -> String.format(
            "[data-uie-name='connect-request'][data-uie-uid='%s'] [data-uie-name='do-accept']", uid);

        public static final Function<String, String> cssIgnoreRequestButtonById = uid -> String.format(
            "[data-uie-name='connect-request'][data-uie-uid='%s'] [data-uie-name='do-ignore']", uid);

        public static final String cssAllConnectionRequests = "[data-uie-name='connect-request']";

        public static final Function<String, String> cssRequestAvatarByUserId = uid -> String.format(
            "[data-uie-name='connect-request'][data-uie-uid='%s'] .image", uid);

        public static final Function<String, String> cssKnownConnectionAvatarsById = uid -> String.format(
            "[data-uie-name='connect-request'][data-uie-uid='%s'] user-avatar", uid);

        public static final Function<String, String> cssKnownConnectionOthersTextById = uid -> String.format(
            "[data-uie-name='connect-request'][data-uie-uid='%s'] [data-uie-value='others']", uid);
    }
    ...
    public static final class PeoplePickerPage {
        ...
        public static final Function<String, String> xpathSearchResultByName = (name) -> String.format(
            "%s//*[@data-uie-name='item-user' and .//*[text()='%s']]", xpathRoot, name);

        public static final Function<String, String> xpathSearchResultGroupByName = (name) -> String.format(
            "%s//*[@data-uie-name='item-group' and .//*[text()='%s']]", xpathRoot, name);

        public static final String cssCloseSearchButton = ".search-header span[data-uie-name='do-close']";

        public static final Function<String, String> cssDismissIconByName = (name) -> String.format(
            "div[data-uie-value='%s'] span.icon-dismiss", name);

        public static final Function<String, String> cssAddIconByName = (name) -> String.format(
            "div[data-uie-value='%s'] span.icon-add", name);
        ...
        public static final Function<String, String> xpathSearchPendingResultByName = (name) -> String.format(
        ...
        public static final Function<String, String> cssTopPeopleListByName = (name) -> String.format(
            ".people-picker-list-top-conversations [data-uie-value='%s'] user-avatar", name);
    ...
    public static final class RegistrationPage {
        ...
        public static final String cssNameFiled = cssRootForm + " [data-uie-name=enter-name]";

        public static final String cssEmailFiled = cssRootForm + " [data-uie-name=enter-email]";

        public static final String cssPasswordFiled = cssRootForm + " [data-uie-name=enter-password]";
    ...
    public static final class SelfPictureUploadPage {
        ...
        public static final String xpathConfirmPictureSelectionButton = xpathRootDiv + "//*[@data-uie-name='do-set-picture']";
    ...
    public static final class ContactsUploadPage {
        ...
        public static final String xpathCloseButton = xpathRootDiv + "//*[@data-uie-name='do-close']";

        public static final String xpathShowSearchButton = xpathRootDiv + "//*[@data-uie-name='go-search']";
    }
    ...
    public static final class WarningPage {
        ...
        public static final String cssMissingWebRTCSupportWarningBar = cssWarningBarRootDiv + " .warning";

        public static final String cssMissingWebRTCSupportWarningBarClose = cssWarningBarRootDiv + " .warning-bar-close";

        public static final String cssAnotherCallWarningModal = cssWarningModalRootDiv + " .modal-call-second.modal-show";

        public static final String cssAnotherCallWarningModalClose = cssAnotherCallWarningModal + " .icon-close";

        public static final String cssFullCallWarningModal = cssWarningModalRootDiv
            + " .modal-call-voice-channel-full.modal-show";

        public static final String cssFullCallWarningModalClose = cssFullCallWarningModal + " .icon-close";

        public static final Function<String, String> xpathMissingWebRTCSupportWarningBarLinkByCaption = (name) -> String
            .format("%s//div[contains(@class, 'warning-bar-message')]//a[text()='%s']", xpathWarningBarRootDiv, name);

        public static final Function<String, String> xpathAnotherCallWarningModalButtonByCaption = (name) -> String
            .format(
                "%s//div[@data-uie-name='modal-call-second' and contains(@class, 'modal-show')]//div[contains(@class, 'button') and text()='%s']",
                xpathWarningModalRootDiv, name);

        public static final Function<String, String> xpathFullCallWarningModalButtonByCaption = (name) -> String
            .format(
                "%s//div[@data-uie-name='modal-call-voice-channel-full' and contains(@class, 'modal-show')]//div[contains(@class, 'button') and text()='%s']",
                xpathWarningModalRootDiv, name);
    }

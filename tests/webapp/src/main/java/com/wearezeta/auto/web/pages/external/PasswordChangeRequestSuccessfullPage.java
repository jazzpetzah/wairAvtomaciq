...
public class PasswordChangeRequestSuccessfullPage extends WebPage {
	...
	public PasswordChangeRequestSuccessfullPage(Future<ZetaWebAppDriver> lazyDriver)
			throws Exception {
		super(lazyDriver);
	}
	...
	public void waitUntilVisible(int timeoutSeconds) throws Exception {
		assert DriverUtils.waitUntilLocatorIsDisplayed(getDriver(),
				...
				timeoutSeconds) : "Password change request confirmation page has not been shown after "

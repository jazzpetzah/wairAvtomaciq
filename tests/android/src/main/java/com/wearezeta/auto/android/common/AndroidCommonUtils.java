...
public class AndroidCommonUtils extends CommonUtils {
	...
	/**
	 * This method will hide the current activity. Do not forget to restore it
	 * if needed
	 *
	 * @throws Exception
	 */
	public static void insertContact(String name, String email,
		...
		executeAdb(String
				.format("shell am start -a android.intent.action.INSERT -t vnd.android.cursor.dir/contact -e name '%s' -e email %s -e phone %s",
	...
	public static void insertContact(String name, String email)
			throws Exception {
		executeAdb(String
				.format("shell am start -a android.intent.action.INSERT -t vnd.android.cursor.dir/contact -e name '%s' -e email %s",
						name, email));
		// To save changes
		tapHomeButton();
	}
	...
	public static void insertContact(String name, PhoneNumber phoneNumber)
			throws Exception {
		executeAdb(String
				.format("shell am start -a android.intent.action.INSERT -t vnd.android.cursor.dir/contact -e name '%s' -e phone %s",

...
public class PeoplePickerPage extends AndroidPage {
    ...
    public void tapOnContactInTopPeoples(String name) throws Exception {
        ...
        verifyLocatorPresence(locator, String.format("Top People item '%s' is not visible", name)).click();
    }
    ...
    public void tapClearButton() throws Exception {
        verifyLocatorPresence(By.id(idPeoplePickerClearbtn), "Clear button is not visible").click();
    }

Feature: Registration2
  ...
  Scenario Outline: Register new user by phone and set profile picture using camera 2
  ...
  @C438072 @rc @regression @torun
  Scenario Outline: Verify sign in with email address only 2
  ...
  @C3822 @regression @torun
  Scenario Outline: Sign in to Wire by mail 2

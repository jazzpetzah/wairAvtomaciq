Feature: Analytics
  ...
  Scenario Outline: Verify registration statistics is sent
    ...
    Then I verify that <LogType> log contains string "PHONE_REGISTRATION"
    And I verify that <LogType> log contains string "appLaunch"
    And I verify that <LogType> log contains string "APP_LAUNCH_MECHANISM=direct"
    And I verify that <LogType> log contains string "registration"
    And I verify that <LogType> log contains string "CONTEXT=phone"
    ...
    Then I verify that <LogType> log contains string "PHONE_REGISTRATION__VERIFY_CODE"
    And I verify that <LogType> log contains string "registration.verified_phone"
    When I input my name
    Then I verify that <LogType> log contains string "PHONE_REGISTRATION__ADD_NAME"
    And I verify that <LogType> log contains string "registration.entered_name"
    And I verify that <LogType> log contains string "registration.succeeded"
    When I select to choose my own picture
    Then I verify that <LogType> log contains string "PHONE_REGISTRATION__ADD_PHOTO"
    ...
    Then I verify that <LogType> log contains string "CONVERSATION_LIST"

Feature: Registration4
  ...
  @C6674 @regression @rc @torun
  Scenario Outline: Register new user by phone and set profile picture using camera 4
  ...
  @C438074 @rc @regression @torun
  Scenario Outline: Verify sign in with email address only 4
  ...
  @C3824 @regression @torun
  Scenario Outline: Sign in to Wire by mail 4

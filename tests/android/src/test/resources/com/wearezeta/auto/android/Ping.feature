Feature: Ping
  ...
  Scenario Outline: Verify you can send Ping & Hot Ping in a group conversation
    ...
    Examples: 
      | Login      | Password      | Name      | Contact1  | Contact2  | GroupChatName1    | GroupChatName2       | Message | Action1 | Action2      |
      | user1Email | user1Password | user1Name | user3Name | user2Name | SendPingGroupChat | SendHotPingGroupChat | YOU     | PINGED  | PINGED AGAIN |

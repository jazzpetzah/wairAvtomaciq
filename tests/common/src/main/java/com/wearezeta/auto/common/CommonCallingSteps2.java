...
public final class CommonCallingSteps2 {
    ...
    private static final String ZCALL_DEFAULT_VERSION = "2.9.13";
    ...
    private static final String AUTOCALL_DEFAULT_VERSION = "2.9.13";
    ...
    private void createInstances(final List<String> calleeNames, String instanceType, String platform, String scenarioName) throws InterruptedException,
        ...
        CompletableFuture.allOf(createTasks.values().toArray(new CompletableFuture[createTasks.size()]))
                .get(INSTANCE_START_TIMEOUT_SECONDS * 2, TimeUnit.SECONDS);
    }

...
public enum AccentColor {
	Undefined(0, "Undefined", "#ffffff"), StrongBlue(1, "StrongBlue", "#2391d3"), StrongLimeGreen(
			2, "StrongLimeGreen", "#00c800"), BrightYellow(3, "BrightYellow",
			"#febf02"), VividRed(4, "VividRed", "#fb0807"), BrightOrange(5,
			"BrightOrange", "#ff8900"), SoftPink(6, "SoftPink", "#fe5ebd"), Violet(
			7, "Violet", "#9c00fe");
	...
	private AccentColor(int id, String name, String hexColor) {
		this.id = id;
		this.name = name;

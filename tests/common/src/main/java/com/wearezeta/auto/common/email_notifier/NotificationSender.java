...
public class NotificationSender {
    ...
    private NotificationSender() {
        ...
        try {
            username = MessagingUtils.getDefaultAccountName();
            password = MessagingUtils.getDefaultAccountPassword();
        } catch (Exception e) {
    ...
    public void send(String recipients, String subject, String text) throws MessagingException {
        send(Arrays.asList(recipients.split(",")), subject, text);
    }

    public void send(List<String> recipients, String subject, String text) throws MessagingException {

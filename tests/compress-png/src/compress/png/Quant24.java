...
public class Quant24 {
    ...
    private double variance(Quant24.Cube cube) {
        ...
        double xx = this.m2[indexify(cube.R1, cube.G1, cube.B1)] - this.m2[indexify(cube.R1, cube.G1, cube.B0)] - this.m2[indexify(cube.R1, cube.G0, cube.B1)] + this.m2[indexify(cube.R1, cube.G0, cube.B0)] - this.m2[indexify(cube.R0, cube.G1, cube.B1)] + this.m2[indexify(cube.R0, cube.G1, cube.B0)] + this.m2[indexify(cube.R0, cube.G0, cube.B1)] - this.m2[indexify(cube.R0, cube.G0, cube.B0)];
        return xx - (dr * dr + dg * dg + db * db) / volume(cube, this.vwt);
    }

    private Object[] maximize(Quant24.Cube cube, int direction, int first, int last, double whole_r, double whole_g, double whole_b, double whole_w) {

...
public class Config {
    ...
    private static final String STEP_PACKAGES_KEY = "picklejar.steps.packages";
    private static final String ANNOTATION_PACKAGES_KEY = "picklejar.annotation.packages";
    private static final String SKIP_ANNOTATION_CLASS_KEY = "picklejar.annotation.skip";
    ...
    public static final String[] ANNOTATION_PACKAGES = System.getProperty(ANNOTATION_PACKAGES_KEY, "cucumber.api.java.en").
            split(",");
    public static final String SKIP_ANNOTATION_CLASS = System.getProperty(SKIP_ANNOTATION_CLASS_KEY, "cucumber.api.Pending");

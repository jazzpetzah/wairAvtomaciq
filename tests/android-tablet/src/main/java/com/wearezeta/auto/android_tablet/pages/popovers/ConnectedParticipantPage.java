...
class ConnectedParticipantPage extends AbstractParticipantPage {
    private final static Function<String, String> xpathNameByValue = value -> String
            .format("//*[@id='ttv__single_participants__header' and @value='%s']", value);

    private final static Function<String, String> xpathEmailByValue = value -> String
            .format("//*[@id='ttv__single_participants__sub_header' and @value='%s']", value);

    public ConnectedParticipantPage(Future<ZetaAndroidDriver> lazyDriver, GroupPopover container) throws Exception {

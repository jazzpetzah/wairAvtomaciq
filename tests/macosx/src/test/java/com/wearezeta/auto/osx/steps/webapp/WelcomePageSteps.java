...
public class WelcomePageSteps {
    ...
    /**
     * Upload a picture from local file system. The picture file itself should already exist on the local file system and should
     * be located in the ~/Documents folder
     *
     * @step. ^I choose (.*) as my self picture on Welcome page$
     *
     * @param pictureName existing picture name
     *
     * @throws Exception
     */

...
public class PeoplePickerPageSteps {
	 ...
	 *
	 * @param user search string (usually user name or email)
	 * @throws Exception
	 */
	 ...
	 * @param user user name string
	 *
	 * @throws AssertionError if there is no user in search results
	 */
	 ...
	 * from search results$
	 *
	 * @param contactState select type of search result entry: connected, group,
	 ...
	 *
	 * @throws AssertionError if TOP PEOPLE list did not appear
	 */

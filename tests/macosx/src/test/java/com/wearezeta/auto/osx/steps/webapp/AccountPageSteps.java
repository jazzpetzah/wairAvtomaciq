...
public class AccountPageSteps {
    ...
    public void IDoNotSeeLogout() throws Exception {
        assertTrue("Logout should NOT be visible", context.getWebappPagesCollection().getPage(AccountPage.class).isLogoutInvisible());
    }
    ...
    public void IVerifyMyAvatarColor(String colorName) throws Exception {
        ...
        final AccentColor avatarColor = context.getWebappPagesCollection().getPage(AccountPage.class).getCurrentAvatarAccentColor();

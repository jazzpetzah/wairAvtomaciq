...
public class OSXConstants {
	public static final class Scripts {
		...
		public static final String PASSWORD_PAGE_VISIBLE_SCRIPT = SCRIPTS_FOLDER + "change_password_page_visible.txt";

		public static final String OPEN_SAFARI_WITH_URL_SCRIPT = SCRIPTS_FOLDER + "open_safari_with_url.txt";
	}

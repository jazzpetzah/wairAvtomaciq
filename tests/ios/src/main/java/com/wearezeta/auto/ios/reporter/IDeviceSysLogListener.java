...
public class IDeviceSysLogListener extends Thread {

	private static Logger log = ZetaLogger.getLog(IDeviceSysLogListener.class
			.getSimpleName());
	...
	public IDeviceSysLogListener() {

	}

	public void startListeningLogcat() {
		String idevicesyslogCommand = "idevicesyslog";
		try {
			process = Runtime.getRuntime().exec(
					new String[] { "/bin/bash", "-c", idevicesyslogCommand });
		} catch (IOException e) {

...
public class ReporterConstants {
	...
	public static final class Values {
		...
		public static final String CPU = "% User Load";

		public static final String FREE_PHYSICAL_MEM = "Physical Memory Free";

		public static final String FREE_PHYSICAL_MEM_NORMALIZED = "Free Physical Mem";

		public static final String TOTAL_TX = "Net Bytes Out";

		public static final String TOTAL_RX = "Net Bytes In";

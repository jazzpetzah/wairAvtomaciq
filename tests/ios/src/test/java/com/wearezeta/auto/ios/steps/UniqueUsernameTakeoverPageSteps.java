...
public class UniqueUsernameTakeoverPageSteps {
    ...
    private static String autoUniqueName = null;

    public static String getAutoUniqueName() {
        if (autoUniqueName == null) {
            throw new IllegalStateException("'autoUniqueName' variable should be initialised first");
        }
        return autoUniqueName;
    }
    ...
    @When("^I rememeber autogenerated unique username on Unique Username Takeover page$")
    public void IRememeberAutogeneratedUniqueName() throws Exception {
        autoUniqueName = getPage().getUniqueNameValue();
    }
}

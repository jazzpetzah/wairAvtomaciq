...
- (NSObject<HTTPResponse> *)httpResponseForMethod:(NSString *)method URI:(NSString *)path
{
    ...
    if (pathComponents.count == 3 && [[pathComponents objectAtIndex:0] isEqualToString:@"session"] &&
         [[pathComponents objectAtIndex:2] isEqualToString:@"screenshot"] && [method isEqualToString:@"GET"])
	{
    ...
    if (pathComponents.count == 5 && [[pathComponents objectAtIndex:0] isEqualToString:@"session"] && [[pathComponents objectAtIndex:2] isEqualToString:@"element"] && [[pathComponents objectAtIndex:4] isEqualToString:@"submit"] && [method isEqualToString:@"POST"])
	{
        return [SERVER.handler postSubmit:path];
	}
    ...
    if (pathComponents.count == 3 && [[pathComponents objectAtIndex:0] isEqualToString:@"session"] && [[pathComponents objectAtIndex:2] isEqualToString:@"moveto"] && [method isEqualToString:@"POST"])
	{
        return [SERVER.handler postMoveTo:path data:[request body]];
	}
    
    // POST /session/:sessionId/click
    if (pathComponents.count == 3 && [[pathComponents objectAtIndex:0] isEqualToString:@"session"] && [[pathComponents objectAtIndex:2] isEqualToString:@"click"] && [method isEqualToString:@"POST"])
	{
        return [SERVER.handler postClick:path data:[request body]];
	}
